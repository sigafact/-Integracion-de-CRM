...
backend_redis_create() {
  print_banner
  printf "${WHITE} 💻 Creación de bases de datos Redis y Postgres...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_set_env() {
  print_banner
  printf "${WHITE} 💻 Configuración de variables de entorno (backend)...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_nginx_setup() {
  print_banner
  printf "${WHITE} 💻 Configuración de nginx (backend)...${GRAY_LIGHT}"
  printf "\n\n"
