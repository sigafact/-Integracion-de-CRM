...
system_mv_folder() {
  print_banner
  printf "${WHITE} 💻 Descargando el sistema...${GRAY_LIGHT}"
  printf "\n\n"
...
system_create_folder() {
  print_banner
  printf "${WHITE} 💻 Ahora, vamos a crear la nueva carpeta....${GRAY_LIGHT}"
  printf "\n\n"
...
system_unzip_whaticket() {
  print_banner
  printf "${WHITE} 💻 Desembalaje del sistema...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos a eliminar Kmenu...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos a bloquear el menú...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Bloqueo de instancia/empresa ${empresa_bloquear} completado exitosamente ...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Desbloqueemos el menú...${GRAY_LIGHT}"
  printf "\n\n"
...
system_node_install() {
  print_banner
  printf "${WHITE} 💻 Instalación de node.js...${GRAY_LIGHT}"
  printf "\n\n"
...
system_docker_install() {
  print_banner
  printf "${WHITE} 💻 Instalación de redis...${GRAY_LIGHT}"
  printf "\n\n"
