					...
					{({ touched, errors, isSubmitting, values, setFieldValue }) => (
						<Form>
							<DialogContent dividers>
								...
								<h3>Reaparición</h3>
								<p>
									Puedes elegir enviar el mensaje de forma recurrente y seleccionar el intervalo.
                                                                        Si se trata de un mensaje que debe enviarse una sola vez, no modifiques nada en esta sección..
								</p>
								<br />
								<Grid container spacing={1}>
