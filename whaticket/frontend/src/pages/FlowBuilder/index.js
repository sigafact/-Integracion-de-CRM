...
const FlowBuilder = () => {
  ...
  const handleDuplicateFlow = async flowId => {
    try {
      ...
      toast.success("Duplicar flujo exitosamente");
    } catch (err) {
      toastError(err);
    }
  };
  ...
  return (
    <MainContainer className={classes.mainContainer}>
      ...
      >
        {deletingContact
          ? `¿Estás seguro que deseas eliminar esta transmisión? Se perderán todas las integraciones relacionadas..`
